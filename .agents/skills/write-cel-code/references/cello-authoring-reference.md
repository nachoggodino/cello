...
This is the compact installed reference for day-to-day `.cel` authoring. For formula selection and syntax, read [hyperformula-functions.md](hyperformula-functions.md).
